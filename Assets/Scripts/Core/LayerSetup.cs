...
namespace GoldRush.Core
{
    public static class LayerSetup
    {
        ...
        public static void Initialize()
        {
            ...
            // Sand collides with: Terrain, Infrastructure, Sand, Water
            // Sand does NOT collide with: Player, WetSand, Gold, Slag
            ...
            Debug.Log("LayerSetup: Collision matrix configured");
        }
